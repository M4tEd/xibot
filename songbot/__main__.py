...
blocks/flags all Discord domains. Behavioral validation goes through the
headless harness (``python -m songbot.harness``); the live playtest is the user's deferred
